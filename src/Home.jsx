...
const Home = () => {
    ...
    return (
        // Ensured min-h-screen covers full vertical space, used relative for positioning context
        <div style={{ backgroundColor: COLORS.Background }} className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                {timedVideoSources.map((video, index) => (
                    <video
                        ...
                        // Fixed: Ensuring video always covers the entire container and uses the opacity transition
                        className={`
                        ...
                        style={{ 
                            ...
                            filter: 'blur(2px)' // Blur remains for readability
                        }}
                    >
            ...
            {/* 2. OVERLAY DARKENER (z-10) - Increased opacity slightly for better text contrast */}
            <div className="absolute inset-0 bg-black opacity-50 z-10"></div>
            
            {/* 3. FOREGROUND CONTENT (z-20) */}
            {/* Flexbox setup for vertical centering, ensures content doesn't overflow horizontally with p-4 */}
            <div className="relative z-20 flex flex-col items-center justify-center min-h-screen p-4 text-center">
                
                {/* Navigation / Header - Ensure full width and max-width works with p-6 */}
                <nav className="absolute top-0 w-full p-6 flex justify-between items-center max-w-7xl mx-auto">
                    ...
                    {/* Video Indicator: Small, easily readable */}
                ...
                <div className="max-w-4xl mx-auto pt-20 pb-20"> {/* Added vertical padding to ensure space for nav and buttons */}
                    ...
                    {/* BODY TEXT (Responsive Text Sizes) */}
                    <p 
                ...
                {/* Changed to flex-col on small screens and space-y to prevent buttons from overlapping on tiny phones */}
                <div 
